...
$route['work-experience'] = 'backend/workexperience';
$route['about-me'] = 'backend/aboutme';
$route['education'] = 'backend/education';
$route['courses'] = 'backend/courses';
$route['skills'] = 'backend/skills';
$route['references'] = 'backend/references';
